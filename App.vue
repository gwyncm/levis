...
import { BASESCHED, BASEDATA, baseFetch, baseReload } from './components/baseManager'
...
export default {
  ...
  methods: {
    ...
    async tableSave() {
      ...
      if (r === true) {
        await baseFetch(`${BASEDATA}/tables/saveall`, "POST", {});
        await baseFetch(`${BASESCHED}/server/reload`, "POST", {});
      }
    },

    async startClock() {
      var servtime = await baseReload(BASESCHED + `/server/time`);
...
<template>
        ...
        <div class="container-fluid">
          <div class="row align-items-start">
            <div class="col-2"></div>
            <div class="col-2 "><h3 style="padding-top: 10px;">Event Manager </h3></div>
